...
public class Header extends VBox{
	...
	private static Color backgroundHeader = Color.web("#2c2f33");
	private static BackgroundFill fillHeader = new BackgroundFill(
			backgroundHeader, null, Insets.EMPTY);
	...
	public Header() {
		...
		titleBarCont.setBackground(new Background(fillHeader));
